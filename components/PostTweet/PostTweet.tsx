...
const PostTweet = () => {
  return (
    <div className="bg-footer w-full py-5 px-5 rounded-[1.3rem] flex justify-between">
      <div className="flex gap-2.5 w-full justify-between">
        ...
        <div className="focus:ring-0  focus:ring-offset-0 text-sm bg-footer w-full">
          <div className="px-4 bg-footer">
            <textarea id="comment" className="focus:ring-offset-0 py-0 bg-footer w-full px-0 text-sm text-white border-0 focus:ring-0 resize-none overflow-y-hidden placeholder:text-[#ececec]" placeholder="What's on your mind?" required defaultValue={""} />
          </div>
          <div className="flex pl-0 mt-2 space-x-1 sm:pl-2">
      ...
      <Link href="#">
        <FontAwesomeIcon icon={faPlusCircle} className="text-[24px] orange-color" />
      </Link>
    </div>
  )
}
